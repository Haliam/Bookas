    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-8">
          <h1
            className="text-black font-bold tracking-tight mb-1"
        ...
        {/* Title */}
        <div className="text-center mb-8">
          <h2 className="text-black text-xl font-semibold mb-2">Bienvenido</h2>
          <p className="text-black/70 text-sm">Inicia sesión para continuar</p>
        </div>
