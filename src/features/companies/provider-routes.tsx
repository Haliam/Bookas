...
const CreateCompany = lazy(() => import("./screens/CreateCompany").then(m => ({ default: m.CreateCompany })));
const ProviderCompanies = lazy(() => import("./screens/Companies").then(m => ({ default: m.ProviderCompanies })));
