    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-5 mt-4 bg-[#FEF7E0] rounded-2xl p-4 mb-5">
        <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-sm font-medium text-[#D4950A]">
            Placeholder · Fase 2
          </p>
        </div>
        <p className="text-xs text-[#D4950A]/80">
          Los reportes completos estarán disponibles en la próxima
          actualización. Los datos mostrados son simulados.
        </p>
      </div>
      ...
      <div className="px-5 flex flex-col gap-5">
            ...
            <button
              ...
              className={`flex-1 h-9 rounded-xl text-xs font-medium ${
                i === 2
                  ...
                  : 'bg-white text-[#6B7280] border border-[#F0F0F0]'
              }`}
            >
              {p}
            </button>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            },
            {
              ...
              value: '4.8',
              sub: 'Basado en 23 reseñas',
              color: '#E14F61',
            },
          ].map(({ icon, label, value, sub, color }) => (
            <div
              key={label}
              className="bg-white rounded-2xl p-4 shadow-[0_1px_6px_rgba(0,0,0,0.05)]"
            >
              <span className="text-2xl">{icon}</span>
              <p className="text-xl font-semibold text-[#111827] mt-2">
                {value}
              </p>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-[0_1px_6px_rgba(0,0,0,0.05)]">
          ...
          <p className="text-center text-[10px] text-[#D1D5DB]">
            Datos simulados · No funcional
          </p>
        </div>
