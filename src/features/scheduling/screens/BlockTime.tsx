    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-5 py-4">
        ...
        <div className="bg-[#FEF7E0] rounded-2xl p-4 mb-5 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-[#6B7280] leading-relaxed">
              Durante el tiempo bloqueado, los clientes no podrán reservar
              citas. Ideal para vacaciones, días festivos o descansos.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div
            className={
              blockType === 'recurring' ? 'grid grid-cols-2 gap-3' : ''
            }
          >
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-[#111827] font-medium">
                  {blockType === 'single'
                    ? new Date(form.startDate + 'T12:00').toLocaleDateString(
                        'es-ES',
                      )
