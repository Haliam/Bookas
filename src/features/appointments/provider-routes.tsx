...
const ProviderAppointmentDetail = lazy(() =>
  import("./screens/ProviderAppointmentDetail").then(m => ({ default: m.ProviderAppointmentDetail }))
);
const ProviderAppointments = lazy(() => import("./screens/ProviderAppointments").then(m => ({ default: m.ProviderAppointments })));
