...
export function TodaySummary({ reservationsCount, pendingCount }: TodaySummaryProps) {
  const hasAppointments = reservationsCount > 0;

  return (
    <section className="px-5 py-6 border-t border-[#F0F0F0]">
      <h2 className="text-[#9CA3AF] text-xs font-medium uppercase tracking-wide mb-3">Hoy</h2>
      ...
      {hasAppointments ? (
        ...
        <p className="text-[#2C2C2C] text-2xl font-semibold mb-2">No tienes reservas</p>
      )}
