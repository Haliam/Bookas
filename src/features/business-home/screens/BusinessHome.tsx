...
export function BusinessHome() {
  const { todayReservationsCount, pendingTodayCount, pendingCount, pendingDetailPath, weekReservationsCount } =
  ...
  return (
    <div className="min-h-screen bg-white max-w-[480px] mx-auto">
      ...
      <TodaySummary reservationsCount={todayReservationsCount} pendingCount={pendingTodayCount} />
